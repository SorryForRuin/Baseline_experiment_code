...
class Player(BasePlayer):
    ...
    ConfirmQ1 = models.StringField(
        label="Please enter whether the FIRST participant you were comared against had performed better, worse or achived the same result",
    ...
    ConfirmQ2 = models.StringField(
        label="Please enter whether the SECOND participant you were comared against had performed better, worse or achived the same result",
        choices=["I have performed BETTER than that player", "I have performed IDENTICALLY compared to that player that player", "I have performed WORSE than that player"])
    ConfirmQ3 = models.StringField(
        ...
        choices=["I have performed BETTER than that player", "I have performed IDENTICALLY compared to that player that player", "I have performed WORSE than that player"])
    confirm_check1 = models.BooleanField(initial=False)
    confirm_check2 = models.BooleanField(initial=False)
    confirm_check3 = models.BooleanField(initial=False)
    likelihood1 = models.IntegerField(label="Please state this in percent. Do not write percent sign")
    likelihood2 = models.IntegerField(label="Please state this in percent. Do not write percent sign")
    payoff1 = models.IntegerField(initial=0)
    payoff2 = models.IntegerField(initial=0)
    actual_payoff = models.IntegerField(initial=0)
